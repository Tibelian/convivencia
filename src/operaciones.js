...
import {PROFESOR} from './app.js';
import {muestraAlerta, eliminarContenido, formatoFecha} from './utilidades.js';
import {mostrarExpulsiones, mostrarAmonestaciones, generarNuevaSancion, mostrarListado} from './generador.js';

//////////////////////////////////////////////////////////
// CREA EL DOM DE LA TABLA CON LOS DATOS DEL AMONESTADO //
//////////////////////////////////////////////////////////
export function obtenerAmonestados(tabla){
...
/////////////////////////////////////////////////////////
export function obtenerGrupos(select){
...
////////////////////////////////////////////////////////////////////////////
export function obtenerAsignaturas(select, id_grupo){
...
//////////////////////////////////////////////////////////
export function obtenerAlumnos(select, id_grupo = 0){
...
//////////////////////////////////////////////////////////
export function obtenerAlumnosTabla(table){
...
/////////////////////////////////////////////////////////
export function guardarAmonestacion(datos){
...
////////////////////////////////////////////////////////
export function guardarExpulsion(datos){
...
//////////////////////////////////////////////////
export function cargarCausas(select, ruta = 'amonestacion'){
...
// CREA EL DOM DE LA TABLA CON LOS DATOS DEL AMONESTADO //
//////////////////////////////////////////////////////////
export function obtenerExpulsiones(tabla){
...
/////////////////////////////////////////
export function cambiarEstadoExpulsion(id, estado){
...
//////////////////////////////////////////////////////////
export function obtenerSanciones(alumnoDiv, tbody, dni, nuevaSancion){
...
///////////////////////////////////////////
export function insertarSancion(cancelar, alumno, sancion, falta = null, tipoFalta = null){
...
/////////////////////////////////////////
export function crearCuerpoTabla(myData){
...
export function generaFila(data){
    let tr = document.createElement("tr");
    for(let i in data){
        let td = document.createElement("td");
