...
import {mostrarInicio, mostrarAcceder, mostrarSanciones, mostrarListado, mostrarExpulsiones, mostrarAmonestaciones} from './generador.js';
import {salir} from './app.js';

// variable que recoge todas las rutas
let BOTONES;

// te devuelve los botones de un profesor según su perfil
export function obtenerBotones(profesor){
    BOTONES = [];
...
export function generarBarraNavegacion(profesor, padreNav){
...
export function activarBoton(texto){
    for(let i = 0; i < BOTONES.length; i++){
