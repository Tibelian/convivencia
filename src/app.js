...
import {Profesor} from './modulos/profesor.js';
import {cargarReloj, eliminarContenido, muestraAlerta} from './utilidades.js';
import {mostrarInicio} from './generador.js';
import {generarBarraNavegacion} from './rutas.js';

// datos del usuario que accede a la aplicación
let PROFESOR = new Profesor(null, null, null, null);
...
// iniciar sesión
export function enviarLogin(usuario, clave){
