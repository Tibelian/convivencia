...
////////////////////////////////////////////
export function eliminarContenido(padre){
...
export function cargarReloj(){
    ...
    reloj.appendChild(document.createTextNode(tiempo));
    
    // cada segundo se vuelve a cargar
    setTimeout(() => {
        cargarReloj();
    }, 1000);
...
// MUESTRA UNA ALERTA //
////////////////////////
export function muestraAlerta(css, msg, close = true){
...
///////////////////////////////////////
// OCULTA Y MUESTRA LA BARRA LATERAL //
///////////////////////////////////////
